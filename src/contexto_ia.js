...
const REGRAS = [
  ...
  "",
  "OFENSA quando:",
  "- o termo xinga, humilha, acusa ou invoca racialismo, Chan ou violencia sexual",
  ...
  "",
  "LEGITIMO quando:",
  "- descreve cor ou aparencia (cabelo preto, olhos negros, preto e branco, noite negra)",
  ...
  "",
  "Na duvida entre OFENSA e LEGITIMO, responda OFENSA.",
  "",
].join("\n");
