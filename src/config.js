...
module.exports = {
  ...
  PARCERIAS_GUILD_ID: process.env.PARCERIAS_GUILD_ID,
  PARCERIAS_CANAL_ID: process.env.PARCERIAS_CANAL_ID,
  PARCERIAS_SOLICITAR_ID: process.env.PARCERIAS_SOLICITAR_ID,
  PARCERIAS_DIVULGADOR_ROLE_ID: process.env.PARCERIAS_DIVULGADOR_ROLE_ID,
  STRAVA_CLIENT_ID: process.env.STRAVA_CLIENT_ID,
  STRAVA_CLIENT_SECRET: process.env.STRAVA_CLIENT_SECRET,
  STRAVA_REFRESH_TOKEN: process.env.STRAVA_REFRESH_TOKEN,
  STRAVA_EXPORT_DIR: process.env.STRAVA_EXPORT_DIR,
};
