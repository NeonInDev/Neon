...
$progressBar.Size = New-Object Drawing.Size(620, 22)
...
$logBox.Text = "[13:05:12] >>> Iniciando instalacao...`r`n[13:05:15] Verificando requisitos... OK`r`n[13:05:18] Copiando projeto Neon...`r`n[13:05:22] Extraindo Node.js...`r`n[13:05:28] Instalando dependencias npm...`r`n[13:05:35] Configurando atalhos..."
$form.Controls.Add($logBox)

$yOff += 318
$installBtn = New-Object Windows.Forms.Button
$installBtn.Text = "▶  INICIAR INSTALAÇÃO"
$installBtn.Size = New-Object Drawing.Size(220, 52)
...
$installBtn.Add_MouseLeave({ $installBtn.BackColor = "#0d1a2e"; $installBtn.ForeColor = "#00d4ff" })
$form.Controls.Add($installBtn)

$abortBtn = New-Object Windows.Forms.Button
$abortBtn.Text = "CANCELAR"
$abortBtn.Size = New-Object Drawing.Size(120, 52)
...
$abortBtn.Add_MouseEnter({ $abortBtn.BackColor = "#ff8800"; $abortBtn.ForeColor = "#0a0a0f" })
$abortBtn.Add_MouseLeave({ $abortBtn.BackColor = "#1a1a00"; $abortBtn.ForeColor = "#ff8800" })
$form.Controls.Add($abortBtn)

$closeBtn2 = New-Object Windows.Forms.Button
$closeBtn2.Text = "FECHAR"
$closeBtn2.Size = New-Object Drawing.Size(120, 52)
